...
int main()
{
    ...
    outStream.open("money_output.txt");
    if (outStream.fail())
    {
        cout << "Faylni ochib bo'lmadi." << endl;
        exit(1);
    ...
    inStream >> amount;
    outStream << "Kiritilgan pul miqdori: " << amount << endl;
    cout << "Kiritilgan pul miqdori faylga yozildi." << endl;
    inStream.close();
    outStream.close();
    return 0;
}
